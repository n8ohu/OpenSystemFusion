...
CDStarRepeaterConfigDVMegaSet::CDStarRepeaterConfigDVMegaSet(wxWindow* parent, int id, const wxString& port, DVMEGA_VARIANT variant, bool rxInvert, bool txInvert, unsigned int txDelay, unsigned int frequency) :
...
m_frequency(NULL)
{
	...
	wxArrayString ports = CDVMegaController::getDevices();
